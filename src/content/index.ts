  ...
  if (response?.success && response.data) {
    ...
    if (state === 'recording' || state === 'paused') {
      ...
      if (recorder && metadata?.testName) {
        try {
          console.log('[Content] Calling recorder.startRecording with testName:', metadata.testName);
          recorder.startRecording(metadata.testName);
          console.log('[Content] recorder.startRecording completed, isRecording:', recorder.isRecording());
        ...
        console.error('[Content] Cannot restore - recorder:', !!recorder, 'testName:', metadata?.testName);
      }
    } else {
